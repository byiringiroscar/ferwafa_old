...
rank_player_team, player_rank, player_rank_points, player_rank_official_table, player_table_points, edit_table_player_points, edit_main_team_profile, legend_story, delete_legend, livematch
